  ...
  useEffect(() => {
    if (id) {
      ...
      if (product) {
        ...
        // Product not found, redirect to admin dashboard
        navigate('/admin')
        return
      }
    }
    ...
    return (
      <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-secondary-600 dark:text-secondary-400">Loading product data...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-secondary-900 dark:text-white">Edit Product</h1>
            </div>
          </div>
        </div>
      </div>
